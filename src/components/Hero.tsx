...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative lg:h-screen bg-black text-white pt-24 lg:py-0">
      ...
      >
        <source
          src="https://cdn.pixabay.com/video/2022/10/11/134355-759233649_large.mp4"
          type="video/mp4"
        />
      </video>
      ...
      <div className="relative z-10 lg:flex h-full w-full lg:justify-between items-center">
        ...
        <div className="max-w-2xl lg:space-y-8 space-y-7 lg:ml-10 ml-5 lg:mt-32">
          <h1 className="max-w-4xl lg:text-6xl text-4xl font-medium cinzel-decorative-regular">
            Stories That <br />
            <span ref={typedElement}></span>
          </h1>
          <p className="max-w-lg">
            Qatarina Wanders is a former circus performer turned author and
            self-made businesswoman (with a wee bit of a unicorn obsession). She
            has edited more than 4,000 books and ghostwritten over 100,
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              />
              <img src={nbclogo} alt="nbc-logo" className="w-14" />
              <img
